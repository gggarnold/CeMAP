...
export const cemap1Unit2Questions: Question[] = [
  ...
  question('c1-u2-t2a-qg5','t2a','Which action best supports the Consumer Duty?',['Testing whether customers understand a material charge','Hiding support behind avoidable barriers','Using product approval once and never reviewing it','Rewarding sales regardless of outcomes'],0,'Testing understanding helps the firm identify and prevent foreseeable customer harm.','Topic 2 Part 1, p.166-167',['Correct.','Support barriers conflict with good outcomes.','Products and outcomes require monitoring.','Incentives should not encourage poor outcomes.']),
  ...
  question('c1-u2-t2b-qg5','t2b','Which is a data-protection requirement?',['Keep every record forever','Collect data without a purpose','Keep personal data accurate and secure','Share personal data whenever requested'],2,'Accuracy and security are core data-protection principles.','Topic 2 Part 2, p.175-176',['Retention must be justified.','Processing needs a specified lawful purpose.','Correct.','Sharing requires a lawful basis and appropriate controls.']),
  ...
  question('c1-u2-t3-qg5','t3','What distinguishes restricted advice?',['It is automatically unsuitable','Its product, provider or service scope is limited and disclosed','It can be given only by trainees','It never involves a personal recommendation'],1,'Restricted advice is advice with a disclosed limitation in range or scope.','Topic 3, p.188-190',['Restriction does not make advice automatically unsuitable.','Correct.','It is not a trainee category.','It can still be a personal recommendation.']),
  ...
  ,
  question('c1-u2-t4-qg5','t4','Which action best demonstrates professionalism?',['Avoiding further learning after qualification','Maintaining competence and acting ethically','Following incentives regardless of suitability','Concealing an error'],1,'Professionalism combines competence, ethical behaviour, accountability and ongoing development.','Topic 4, p.201-203',['Competence must be maintained.','Correct.','Suitability and customer outcomes take priority.','Errors should be handled openly and appropriately.'])
]
