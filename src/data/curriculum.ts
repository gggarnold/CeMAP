...
// "Course Contents" pages. `status: 'complete'` topics have NOT yet had lessons,
// flashcards or questions authored â€” see CONTENT_COVERAGE.md for the full report.
...
export const curriculum: Unit[] = [
  // ---------------- CeMAP 1 ----------------
  {
    module: 'cemap1',
    unitKey: 'unit1',
    title: 'Unit 1 â€” Regulation, Legislation & Key Parties (FRE1)',
    topics: [
  ...
  },
  {
    module: 'cemap1',
    unitKey: 'unit2',
    title: 'Unit 2 â€” Advisers, Clients and Ethics (FRE2)',
    topics: [
  ...
  // ---------------- CeMAP 2 ----------------
  {
    module: 'cemap2',
    unitKey: 'unit1',
    title: 'Unit 1 â€” Mortgage Law, Practice & Application (MRT1)',
    topics: [
  ...
  },
  {
    module: 'cemap2',
    unitKey: 'unit2',
    title: 'Unit 2 â€” Mortgage Products and Post Completion (MRT2)',
    topics: [
  ...
  // ---------------- CeMAP 3 ----------------
  {
    module: 'cemap3',
    unitKey: 'unit1',
    title: 'CeMAP 3 â€” Protection Issues',
    topics: [
