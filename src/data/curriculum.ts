...
export const curriculum: Unit[] = [
  ...
  // ---------------- CeMAP 2 ----------------
  {
    ...
    topics: [
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't1', title: 'Property and Mortgage Markets', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.7-14' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't2_3', title: 'Mortgage Regulation and Types of Borrower', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.15-31' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't4', title: 'Principles of Mortgage and Property Law', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.32-41' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't5', title: 'Property and Mortgage Law', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.42-50' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't6', title: 'Buying a Property: An Overview', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.51-63' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't7_8', title: 'The Legal Side of Property Purchase', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.64-77' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't9_10', title: 'The Role of the Mortgage Adviser', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.78-91' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't11_12', title: 'Credit Status & Suitability', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.92-104' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't13_14', title: 'Property Assessment, Valuations & Surveys', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.105-120' },
      { module: 'cemap2', unitKey: 'unit1', topicKey: 't15', title: 'Other Factors Affecting the Lending Decision', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.121-134' }
    ]
  },
  {
    module: 'cemap2',
    ...
    topics: [
      ...
      { module: 'cemap2', unitKey: 'unit2', topicKey: 't2', title: 'Repayment Vehicles for Interest-Only Mortgages', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.145-158' },
      { module: 'cemap2', unitKey: 'unit2', topicKey: 't3', title: 'Interest Rate Options', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.159-168' },
      { module: 'cemap2', unitKey: 'unit2', topicKey: 't4_5', title: 'Mortgage Products and Schemes', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.169-182' },
      { module: 'cemap2', unitKey: 'unit2', topicKey: 't6', title: 'Raising Additional Funds for Property', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.183-196' },
      { module: 'cemap2', unitKey: 'unit2', topicKey: 't7', title: 'Transferring Mortgages', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.197-208' },
      { module: 'cemap2', unitKey: 'unit2', topicKey: 't8_9', title: 'Arrears and Lenders\u2019 Legal Rights and Remedies', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.209-223' }
    ]
  },
  // ---------------- CeMAP 3 ----------------
  {
    ...
    topics: [
      ...
      { module: 'cemap3', unitKey: 'unit1', topicKey: 't2', title: 'Case Study Practice', status: 'pending', sourcePdf: 'CeMAP 2&3', sourcePages: 'p.237+' }
    ]
  }
]
